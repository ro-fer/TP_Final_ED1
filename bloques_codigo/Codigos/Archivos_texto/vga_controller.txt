...
begin
  ...
  sincronismo_horizontal: hsync
    ...
    -- 3 mux_color--> uno para cada color. si el selector es 1 saca color, sino Blue
    mux_r: mux_color
        port map(
            RGB => r_i_vga,
            B   => '0',
    ...
    pixelx_vga      <= cont_h_vga(6 downto 4); -- saca la posicion de pixel x, indica en que COLUMNA esta, va a la ROM 
    pixely_vga      <= cont_v_vga(6 downto 4); -- saca la posicion de pixel y, indica en que FILA esta, va a la ROM 
