...
HD_PWD='C:/Users/Alpha/Documents/GitHub/TP_Final_ED1/bloques_codigo/Codigos/voltimetro/Sintesis_/Sintesis_.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Voltimetro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Voltimetro.tcl
