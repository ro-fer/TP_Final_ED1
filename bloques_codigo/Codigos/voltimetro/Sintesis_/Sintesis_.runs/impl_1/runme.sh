...
HD_PWD='C:/Users/Alpha/Documents/GitHub/TP_Final_ED1/bloques_codigo/Codigos/voltimetro/Sintesis_/Sintesis_.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Voltimetro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Voltimetro.tcl -notrace
